...
if (!function_exists('getLinkLihatKodeDonasi')) {
    function getLinkLihatKodeDonasi($jenis) {
        switch ($jenis) {
            Default:
                return 'lihatqrkodedonasi.php';
        }
    }
}
...
if (isset($_GET['id'])) {
    ...
    $perintah = "SELECT * FROM kodedonasi WHERE id = '$id'";
    ...
    <nav id="sidebar">
        ...
        <div class="p-4 pt-5">
            ...
            <ul class="list-unstyled components mb-5">
                ...
                <li>
                    <a href="lihatqrkodedonasi.php">Contact</a>
                </li>
                <li>
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
        <body class="body1">
            <div class="container">
                ...
                <a href="<?php echo getLinkLihatKodeDonasi($jenis); ?>" class="btn btn-secondary" style="float: right;">Kembali</a>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        var linkLihatStruktur = "<?php echo getLinkLihatKodeDonasi($jenis); ?>";
                        ...
                        document.getElementById('lihatEditIcon').addEventListener('click', function() {
                            switch (jenis) {
                                default:
                                    ...
                                    window.location.href = 'qrkodedonasi.php';
                            }
                        });
                    });
                </script>
