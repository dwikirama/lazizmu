    ...
    <style>
		...
		.center-container {
            ...
            .banner img {
                max-width: 100%;
                height: auto;
                margin: 0 auto; /* Menggeser gambar ke tengah */
                display: block; /* Menghilangkan margin bawah yang mungkin muncul pada elemen inline */
            }
            ...
            .lazismu-image {
				...
				height: auto; /* Menyesuaikan tinggi sesuai aspek rasio gambar */
...
<body>
    ...
    <div class="menu-top">
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <div>
            <h2 class="mb-4">QR Kode Donasi</h2>
            <div class="qr-code-container">
                <?php
                // Ambil data dari database
                $perintah = "SELECT * FROM kodedonasi ORDER BY id ASC";
                $result = $conn->query($perintah);

                // Tampilkan data secara dinamis
                while ($data = $result->fetch_assoc()) {
				?>
                <img src="./images/<?php echo $data['foto']; ?>" alt="qr kode donasi">
            </div>
			<?php
			}
			?>
