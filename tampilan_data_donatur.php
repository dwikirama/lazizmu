...
<html lang="en">
  <head>
  	<title>TAMPILAN DATA DONASI</title>
    <meta charset="utf-8">
  ...
  <body>
	...
	<div class="menu-top">
	  ...
	  <h1 style="text-align:center;">Tampilan Data Pembayaran</h1>
        <a href="admin_program.php" class="btn btn-primary btn-sm mb-2">Tampilan Data Program</a>
        <a href="tampilan_data_donatur.php" class="btn btn-primary btn-sm mb-2 ml-2">Lihat Data Donatur</a>
...
if (isset($_GET['hapus'])) {
    $id = $_GET['hapus'];
    if (!empty($id)) {
    $sqlhapus = "DELETE FROM pembayaran where id='$id'";
...
$no = 0;
$sql = "SELECT  a.id, a.nama, a.no_telp, a.nominal, a.infaq_id, a.wallet_id, b.namap, b.type, c.namaw from pembayaran a left join infaq b on a.infaq_id = b.id left join wallet c on a.wallet_id = c.id";
