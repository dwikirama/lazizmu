...
if(isset($_POST["submit"])){
	...
	$sql = "INSERT INTO konsultasi_online (nama,contact,email,alamat,question) VALUES
	('$nama','$contact','$email','$alamat','$question')";
		...
		<div class="card-container">
            <div class="left">
                <div class="left-container">
                    <h3>Jika Anda memiliki pertanyaan seputar zakat, infaq, sedekah dan fidyah, silahkan mengisi formulir berikut ini.</h3>
                </div>
            </div>
            <div class="right">
                <div class="right-container">
                    <form action="" method="post">
				        ...
				        <input type="phone" id="contact" name="contact" required>
