...
function getLinkLihatStruktur($jenis) {
    switch ($jenis) {
        case 'badanpengurus':
            return 'lihatstrukturmanajemen2.php';
        case 'badanpengawas':
            return 'lihatstrukturmanajemen3.php';
        case 'dewansyariah':
            return 'lihatstrukturmanajemen4.php';
        default:
            return 'lihatstrukturmanajemen.php';
    }
}
...
if (isset($_GET['id'])) {
    ...
    switch ($jenis) {
        ...
        case 'dewansyariah':
            ...
            break;
        default:
            $table = 'badaneksekutif';
    }

    // Ambil data dari database berdasarkan ID dan jenis
...
if (isset($_POST['ubah'])) {
    ...
    if (!empty($_FILES['ubah_foto']['name'])) {
        ...
        $data_lama = $conn->query("SELECT foto FROM $table WHERE id='$id'")->fetch_assoc();
    ...
    $stmt = $conn->prepare("UPDATE $table SET nama=?, jabatan=?, foto=? WHERE id=?");
...
<head>
    ...
    <style>
        ...
        /* Efek hover pada input nama dan jabatan */
        input#nama:hover,
        input#jabatan:hover {
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
        <body class="body1">
            <div class="container">
                ...
                <a href="<?php echo getLinkLihatStruktur($jenis); ?>" class="btn btn-secondary" style="float: right;">Kembali</a>
                ...
                <form method="post" action="" enctype="multipart/form-data" id="formEditData">
                    ...
                    <label>Nama:</label>
                    <input type="text" name="nama" id="nama" value="<?php echo $data['nama']; ?>" required="required">

                    <!-- Ganti label "Jabatan" dengan "Jabatan" -->
                    <label>Jabatan:</label>
                    <input type="text" name="jabatan" id="jabatan" value="<?php echo $data['jabatan']; ?>" required="required">
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        var linkLihatStruktur = "<?php echo getLinkLihatStruktur($jenis); ?>";
                        ...
                        document.getElementById('lihatEditIcon').addEventListener('click', function() {
                            switch (jenis) {
                                case 'badanpengurus':
                                    // Ganti ini dengan header dan location yang sesuai untuk badanpengurus
                                    window.location.href = 'badan_pengurus.php';
                                    break;
                                case 'badanpengawas':
                                    // Ganti ini dengan header dan location yang sesuai untuk badanpengawas
                                    window.location.href = 'badan_pengawas.php';
                                    break;
                                case 'dewansyariah':
                                    // Ganti ini dengan header dan location yang sesuai untuk dewansyariah
                                    window.location.href = 'dewan_syariah.php';
                                    break;
                                default:
                                    // Ganti ini dengan header dan location yang sesuai untuk default
                                    window.location.href = 'badan_eksekutif.php';
                            }
                        });
                    });
                </script>
