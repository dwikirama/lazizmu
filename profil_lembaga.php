...
if (!$query) {
    die('Error: ' . mysqli_error($conn)); // Menampilkan pesan error jika query gagal dieksekusi
}
...
if (!isset($_SESSION['login_user'])) {
    ...
    exit; // Keluar setelah melakukan redirect
}
?>
...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper d-flex align-items-stretch">
		...
		<h2 class="mb-4" style="text-align: center;"><b>Profil Lembaga</b></h2>
			<p><?= $profil_lembaga['profil_lembaga'] ?></p>
			<div class="banner">
